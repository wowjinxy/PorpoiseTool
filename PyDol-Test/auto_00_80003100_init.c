...
void __start(void) {
    ...
    gc_env.r[5] = 0x1;
L_8000319C:
    // lis r6, InitMetroTRK@ha (waiting for ori @l)
...
void __init_data(void) {
    ...
    //gc_env.r[6] = (uint32_t)&_rom_copy_info;
...
L_800032D4:
    ...
    goto L_8000329C;
L_800032DC:
    //gc_env.r[6] = (uint32_t)&InitMetroTRK;
    gc_env.r[29] = gc_env.r[0]; // Move register
    goto L_800032EC;
L_800032EC:
    goto L_800032F0;
