"""
Handler for PowerPC addis instruction.
"""
...
class AddisHandler:
    """Handles PowerPC addis instruction transpilation."""
...
def handle(instruction: Instruction, transpiler: 'ModularTranspiler') -> List[str]:
    """Entry point for addis instruction handling."""
    return AddisHandler().handle(instruction)