"""
Handler for PowerPC sub instruction.
"""
...
class SubHandler:
    """Handles PowerPC sub instruction transpilation."""
...
def handle(instruction: Instruction, transpiler: 'ModularTranspiler') -> List[str]:
    """Entry point for sub instruction handling."""
    return SubHandler().handle(instruction)