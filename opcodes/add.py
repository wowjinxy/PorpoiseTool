"""
Handler for PowerPC add instruction.
"""
...
class AddHandler:
    """Handles PowerPC add instruction transpilation."""
...
def handle(instruction: Instruction, transpiler: 'ModularTranspiler') -> List[str]:
    """Entry point for add instruction handling."""
    return AddHandler().handle(instruction)