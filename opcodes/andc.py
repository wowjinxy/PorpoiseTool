"""
Handler for PowerPC andc instruction.
"""
...
class AndcHandler:
    """Handles PowerPC andc instruction transpilation."""
...
def handle(instruction: Instruction, transpiler: 'ModularTranspiler') -> List[str]:
    """Entry point for andc instruction handling."""
    return AndcHandler().handle(instruction)
