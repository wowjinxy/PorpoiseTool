"""
Handler for PowerPC subi instruction.
"""
...
class SubiHandler:
    """Handles PowerPC subi instruction transpilation."""
...
def handle(instruction: Instruction, transpiler: 'ModularTranspiler') -> List[str]:
    """Entry point for subi instruction handling."""
    return SubiHandler().handle(instruction)