"""
Handler for PowerPC lhz (Load Halfword and Zero) instruction.
"""
...
class LhzHandler:
    """Handles PowerPC lhz instruction transpilation."""
...
def handle(instruction: Instruction, transpiler: 'ModularTranspiler') -> List[str]:
    """Entry point for lhz instruction handling."""
    return LhzHandler().handle(instruction)