...
void Camera_80028B9C(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x28, gc_env.r[1]); // stwu r1, -0x28(r1)
    ...
    gc_env.r[30] = 0x0; // li r30, 0x0
    gc_env.r[28] = gc_env.r[31] + 4; // addi r28, r31, 0x4
    gc_env.r[3] = gc_env.r[31] + 140; // addi r3, r31, 0x8c
    gc_env.r[4] = gc_mem_read32(gc_env.ram, gc_env.r[6] + 0x68); // lwz r4, 0x68(r6)
    gc_env.r[7] = gc_env.r[4] + 4; // addi r7, r4, 0x4
    gc_env.r[4] = gc_mem_read32(gc_env.ram, gc_env.r[4] + 0x4); // lwz r4, 0x4(r4)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[7] + 0x4); // lwz r0, 0x4(r7)
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x14, gc_env.r[4]); // stw r4, 0x14(r31)
    gc_env.r[4] = 0x224; // li r4, 0x224
    ...
    gc_env.r[5] = gc_mem_read32(gc_env.ram, gc_env.r[6] + 0x64); // lwz r5, 0x64(r6)
    ...
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[8] + 0x8); // lwz r0, 0x8(r8)
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x78, gc_env.r[0]); // stw r0, 0x78(r31)
    ...
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0xa, gc_env.r[30]); // stb r30, 0xa(r31)
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x9, gc_env.r[30]); // stb r30, 0x9(r31)
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x8, gc_env.r[30]); // stb r30, 0x8(r31)
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x4, gc_env.r[30]); // stw r30, 0x4(r31)
    lb_8000C160();
    ...
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x398); // lbz r0, 0x398(r31)
    uint32_t rotated = gc_env.r[30] << 7; // rlwimi r0, r30, 7, 24, 24
    gc_env.r[0] = (gc_env.r[0] & ~0x80) | (rotated & 0x80);
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x398, gc_env.r[0]); // stb r0, 0x398(r31)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x398); // lbz r0, 0x398(r31)
    ...
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x399, gc_env.r[0]); // stb r0, 0x399(r31)
    lb_8000C160();
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[29] + 0x0); // lbz r0, 0x0(r29)
    uint32_t rotated = gc_env.r[30] << 0; // rlwimi r0, r30, 0, 31, 31
    gc_env.r[0] = (gc_env.r[0] & ~0x1) | (rotated & 0x1);
    gc_env.r[28] = gc_env.r[27] * 108; // mulli r28, r27, 108
    gc_mem_write8(gc_env.ram, gc_env.r[29] + 0x0, gc_env.r[0]); // stb r0, 0x0(r29)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x39a); // lbz r0, 0x39a(r31)
    uint32_t rotated = gc_env.r[30] << 7; // rlwimi r0, r30, 7, 24, 24
    gc_env.r[0] = (gc_env.r[0] & ~0x80) | (rotated & 0x80);
    ...
    lb_8000C160();
    gc_env.r[0] = gc_env.r[27] - 1; // subic. r0, r27, 1
    ...
    gc_env.r[0] = gc_env.r[27] - 1; // subi r0, r27, 1
    gc_env.cr[0] = (gc_env.r[0] == 0x8) ? 0 : (gc_env.r[0] < 0x8 ? -1 : 1); // Compare with immediate
    gc_env.r[4] = gc_env.r[27] - 9; // subi r4, r27, 9
    ...
    gc_env.r[0] = gc_env.r[0] * 108; // mulli r0, r0, 108
    gc_env.r[4] = gc_env.r[5] + gc_env.r[0]; // add r4, r5, r0
    ...
    gc_env.r[0] = gc_env.r[0] * 108; // mulli r0, r0, 108
    gc_env.r[6] = cm_804D645C; // lwz r6, cm_804D645C@sda21(r0)
    gc_env.r[5] = gc_env.r[6] + gc_env.r[0]; // add r5, r6, r0
    ...
    goto L_80028F40;
    L_80028EE8:
    gc_env.r[4] = gc_env.r[27] - 1; // subi r4, r27, 1
    gc_env.r[0] = gc_env.r[4] - gc_env.r[3]; // subf r0, r3, r4
    ...
    gc_env.r[4] = gc_env.r[6] + gc_env.r[4]; // add r4, r6, r4
    ...
    L_80028F20:
    gc_env.r[0] = gc_env.r[3] * 108; // mulli r0, r3, 108
    ...
    goto L_80028F48;
    L_80028F40:
    gc_env.r[5] = gc_env.r[3] * 108; // mulli r5, r3, 108
    goto L_80028EE8;
    L_80028F48:
...
void Camera_80028F5C(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[3] + 0x8, gc_env.r[4]); // stw r4, 0x8(r3)
    ...
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0xc); // lbz r0, 0xc(r3)
    uint32_t rotated = gc_env.r[4] << 7; // rlwimi r0, r4, 7, 24, 24
    gc_env.r[0] = (gc_env.r[0] & ~0x80) | (rotated & 0x80);
    gc_mem_write8(gc_env.ram, gc_env.r[3] + 0xc, gc_env.r[0]); // stb r0, 0xc(r3)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0xc); // lbz r0, 0xc(r3)
    ...
    gc_env.r[0] = (gc_env.r[0] & ~0x20) | (rotated & 0x20);
    gc_mem_write8(gc_env.ram, gc_env.r[3] + 0xc, gc_env.r[0]); // stb r0, 0xc(r3)
    gc_mem_write16(gc_env.ram, gc_env.r[3] + 0xe, gc_env.r[4]); // sth r4, 0xe(r3)
...
void Camera_800290D4(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[4] + 0x4, gc_env.r[0]); // stw r0, 0x4(r4)
    goto L_800290F4;
    L_800290EC:
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[3] + 0x4); // lwz r0, 0x4(r3)
    cm_804D6468 = gc_env.r[0]; // stw r0, cm_804D6468@sda21(r0)
...
void Camera_80029124(void) {
    gc_env.r[0] = gc_env.lr; // Move from link register
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x50, gc_env.r[1]); // stwu r1, -0x50(r1)
    ...
    gc_env.f[0] = cm_804D7E18; // lfd f0, cm_804D7E18@sda21(r0)
    ...
    gc_env.f[2] = cm_804D7E20; // lfd f2, cm_804D7E20@sda21(r0)
...
void Camera_8002928C(void) {
    ...
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[3] + 0x8); // lwz r3, 0x8(r3)
    gc_env.cr[0] = (gc_env.r[3] == 0x1) ? 0 : (gc_env.r[3] < 0x1 ? -1 : 1); // Compare with immediate
    if (gc_env.cr[0] == 0) goto L_800293BC;
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0xc); // lbz r0, 0xc(r31)
    ...
    gc_env.r[0] = gc_env.r[3] - 1; // subi r0, r3, 1
    gc_mem_write16(gc_env.ram, gc_env.r[31] + 0xe, gc_env.r[0]); // sth r0, 0xe(r31)
    gc_env.r[3] = 0x0; // li r3, 0x0
    goto L_800293C0;
    L_800292E8:
    Stage_GetCamBoundsLeftOffset();
    ...
    L_80029374:
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0xc); // lbz r3, 0xc(r31)
    ...
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0xc, gc_env.r[3]); // stb r3, 0xc(r31)
    gc_env.r[0] = 0x258; // li r0, 0x258
    gc_mem_write16(gc_env.ram, gc_env.r[31] + 0xe, gc_env.r[0]); // sth r0, 0xe(r31)
    L_80029394:
    gc_env.r[3] = 0x0; // li r3, 0x0
    goto L_800293C0;
    ...
    L_800293A4:
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0xc); // lbz r0, 0xc(r31)
    gc_env.r[3] = 0x1; // li r3, 0x1
    uint32_t rotated = gc_env.r[3] << 5; // rlwimi r0, r3, 5, 26, 26
    gc_env.r[0] = (gc_env.r[0] & ~0x20) | (rotated & 0x20);
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0xc, gc_env.r[0]); // stb r0, 0xc(r31)
    gc_env.r[3] = 0x1; // li r3, 0x1
    goto L_800293C0;
    L_800293BC:
    gc_env.r[3] = 0x0; // li r3, 0x0
...
void Camera_800293E0(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x3C, *(uint32_t*)&temp);
    L_80029560:
    gc_env.r[31] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x4); // lwz r31, 0x4(r31)
    L_80029564:
...
void Camera_8002958C(void) {
    gc_env.r[0] = gc_env.lr; // Move from link register
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0xb0, gc_env.r[1]); // stwu r1, -0xb0(r1)
    ...
    L_800295DC:
    gc_env.r[27] = gc_mem_read32(gc_env.ram, gc_env.r[27] + 0x4); // lwz r27, 0x4(r27)
    L_800295E0:
    ...
    gc_env.r[3] = gc_env.r[0] + gc_env.r[4]; // add r3, r0, r4
    ...
    gc_env.r[31] = cm_804D6468; // lwz r31, cm_804D6468@sda21(r0)
    gc_env.f[26] = cm_804D7E18; // lfd f26, cm_804D7E18@sda21(r0)
    goto L_800299DC;
    L_8002963C:
    gc_env.r[3] = gc_env.r[31]; // Move register
    Camera_8002928C();
    ...
    gc_env.r[5] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x10); // lwz r5, 0x10(r31)
    gc_env.r[3] = gc_env.r[1] + 80; // addi r3, r1, 0x50
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x14); // lwz r0, 0x14(r31)
    gc_env.r[4] = 0x0; // li r4, 0x0
    gc_env.r[30] += 1; // addi r30, r30, 0x1
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x50, gc_env.r[5]); // stw r5, 0x50(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x54, gc_env.r[0]); // stw r0, 0x54(r1)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x18); // lwz r0, 0x18(r31)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x58, gc_env.r[0]); // stw r0, 0x58(r1)
    gc_env.r[5] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x10); // lwz r5, 0x10(r31)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x14); // lwz r0, 0x14(r31)
...
void Camera_80029AAC(void) {
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[3] + 0x10); // lwz r0, 0x10(r3)
    gc_env.cr[0] = (gc_env.r[0] == 0x0) ? 0 : (gc_env.r[0] < 0x0 ? -1 : 1); // Compare with immediate
...
void Camera_80029CF8(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x80, gc_env.r[1]); // stwu r1, -0x80(r1)
    ...
    gc_env.r[30] = gc_env.r[4] + 0; // addi r30, r4, 0x0
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x44, gc_env.r[29]); // stw r29, 0x44(r1)
    gc_env.r[29] = gc_env.r[3] + 0; // addi r29, r3, 0x0
    ...
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x84); // lwz r0, 0x84(r1)
...
void Camera_8002A0C0(void) {
    ...
    gc_env.r[5] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r5, cm_80452C68@ha
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x60, gc_env.r[1]); // stwu r1, -0x60(r1)
    ...
    gc_env.f[0] = *(float*)&temp;
    gc_env.r[0] = gc_env.r[0] - gc_env.r[3]; // subf r0, r3, r0
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x14, gc_env.r[0]); // stw r0, 0x14(r1)
...
void Camera_8002A28C(void) {
    ...
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[4] + 0x90); // lwz r3, 0x90(r4)
    gc_env.cr[0] = (gc_env.r[3] == 0x0) ? 0 : (gc_env.r[3] < 0x0 ? -1 : 1); // Compare with immediate
...
void Camera_8002A4AC(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x38, gc_env.r[1]); // stwu r1, -0x38(r1)
    ...
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[3] + gc_env.r[0]); // lwzx r0, r3, r0
    gc_env.ctr = gc_env.r[0]; // Move to count register
    return gc_env.ctr; // bctr
    L_8002A4F8:
...
void Camera_8002A768(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0xa0, gc_env.r[1]); // stwu r1, -0xa0(r1)
    ...
    gc_env.f[0] = (float)gc_env.f[1] * (float)gc_env.f[0]; // fmuls f0, f1, f0
    gc_env.f[2] = cm_804D7E30; // lfs f2, cm_804D7E30@sda21(r0)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x50, gc_env.r[0]); // stw r0, 0x50(r1)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[6] + 0x8); // lwz r0, 0x8(r6)
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x10, gc_env.r[3]); // stw r3, 0x10(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x14, gc_env.r[0]); // stw r0, 0x14(r1)
...
void Camera_8002B0E0(void) {
    ...
    gc_env.f[0] = cm_804D7E14; // lfs f0, cm_804D7E14@sda21(r0)
    gc_env.r[0] = gc_env.r[0] * 68; // mulli r0, r0, 68
    ...
    gc_env.r[0] = gc_env.r[3] - 1; // subi r0, r3, 1
    gc_mem_write16(gc_env.ram, gc_env.r[4] + 0x0, gc_env.r[0]); // sth r0, 0x0(r4)
    goto L_8002B1A0;
    L_8002B174:
    gc_env.r[3] = ((uint32_t)&cm_803BCCA0 >> 16) & 0xFFFF; // lis r3, cm_803BCCA0@ha
    gc_env.r[3] = gc_env.r[3] + ((uint32_t)&cm_803BCCA0 & 0xFFFF); // addi r3, r3, cm_803BCCA0@l
    ...
    gc_env.f[0] = *(float*)&temp;
    gc_env.f[0] = (double)(int32_t)gc_env.f[0]; // fctiwz f0, f0
    uint64_t temp;
    ...
    gc_mem_write16(gc_env.ram, gc_env.r[31] + 0x2ba, gc_env.r[0]); // sth r0, 0x2ba(r31)
    L_8002B1A0:
    gc_env.r[3] = ((uint32_t)&cm_803BCCA0 >> 16) & 0xFFFF; // lis r3, cm_803BCCA0@ha
    gc_env.r[3] = gc_env.r[3] + ((uint32_t)&cm_803BCCA0 & 0xFFFF); // addi r3, r3, cm_803BCCA0@l
...
void Camera_8002B3D4(void) {
    ...
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x88, gc_env.r[1]); // stwu r1, -0x88(r1)
    ...
    gc_mem_write16(gc_env.ram, gc_env.r[27] + 0x0, gc_env.r[0]); // sth r0, 0x0(r27)
    L_8002B628:
    Stage_GetCamBoundsLeftOffset();
    gc_env.f[31] = gc_env.f[1]; // fmr f31, f1
    Stage_GetCamBoundsRightOffset();
    ...
    gc_env.r[3] += 1; // addi r3, r3, 0x1
    gc_mem_write16(gc_env.ram, gc_env.r[27] + 0x0, gc_env.r[3]); // sth r3, 0x0(r27)
    gc_env.r[3] = (int32_t)(int16_t)gc_mem_read16(gc_env.ram, gc_env.r[27] + 0x0); // lha r3, 0x0(r27)
    gc_env.f[1] = cm_804D7E20; // lfd f1, cm_804D7E20@sda21(r0)
    ...
    gc_env.f[2] = *(float*)&temp;
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x64, gc_env.r[3]); // stw r3, 0x64(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x60, gc_env.r[0]); // stw r0, 0x60(r1)
...
void Camera_8002B694(void) {
    ...
    gc_env.r[4] = gc_env.r[3] * 68; // mulli r4, r3, 68
    gc_env.f[0] = cm_804D7E74; // lfs f0, cm_804D7E74@sda21(r0)
    gc_env.r[3] = ((uint32_t)&HSD_PadCopyStatus >> 16) & 0xFFFF; // lis r3, HSD_PadCopyStatus@ha
    ...
    gc_env.r[5] = 0x0; // li r5, 0x0
    gc_env.f[1] = cm_804D7E14; // lfs f1, cm_804D7E14@sda21(r0)
    gc_env.r[4] = gc_env.r[5] * 68; // mulli r4, r5, 68
    gc_env.f[0] = cm_804D7E74; // lfs f0, cm_804D7E74@sda21(r0)
    gc_env.r[3] = ((uint32_t)&HSD_PadCopyStatus >> 16) & 0xFFFF; // lis r3, HSD_PadCopyStatus@ha
    gc_env.r[0] = gc_env.r[3] + ((uint32_t)&HSD_PadCopyStatus & 0xFFFF); // addi r0, r3, HSD_PadCopyStatus@l
    gc_env.r[3] = gc_env.r[0] + gc_env.r[4]; // add r3, r0, r4
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[30] + 0xC, *(uint32_t*)&temp);
    gm_801A3680();
    gc_mem_write32(gc_env.ram, gc_env.r[30] + 0x14, gc_env.r[4]); // stw r4, 0x14(r30)
    ...
    gc_env.r[4] = gc_env.r[31] * 68; // mulli r4, r31, 68
    gc_env.r[3] = ((uint32_t)&HSD_PadCopyStatus >> 16) & 0xFFFF; // lis r3, HSD_PadCopyStatus@ha
    gc_env.r[0] = gc_env.r[3] + ((uint32_t)&HSD_PadCopyStatus & 0xFFFF); // addi r0, r3, HSD_PadCopyStatus@l
    gc_env.r[4] = gc_env.r[0] + gc_env.r[4]; // add r4, r0, r4
    uint32_t temp = gc_mem_read32(gc_env.ram, gc_env.r[4] + 0x20); // lfs f0, 0x20(r4)
    gc_env.f[0] = *(float*)&temp;
    gc_env.r[3] = gc_env.r[31]; // Move register
    float temp = (float)gc_env.f[0]; // stfs f0, 0x0(r30)
...
void Camera_8002BA00(void) {
    ...
    gc_env.r[30] = 0x5; // li r30, 0x5
    goto L_8002BA5C;
    L_8002BA40:
    gc_env.r[30] = gc_env.r[30] + gc_env.r[31]; // add r30, r30, r31
    if (gc_env.cr[0] >= 0) goto L_8002BA50;
    gc_env.r[30] = 0xa; // li r30, 0xa
    goto L_8002BA5C;
    L_8002BA50:
...
void Camera_8002BAA8(void) {
    ...
    gc_env.f[2] = 1.0 / sqrt(gc_env.f[5]); // frsqrte f2, f5
    gc_env.f[4] = cm_804D7E78; // lfd f4, cm_804D7E78@sda21(r0)
    gc_env.f[3] = cm_804D7E80; // lfd f3, cm_804D7E80@sda21(r0)
    gc_env.f[0] = gc_env.f[2] * gc_env.f[2]; // fmul f0, f2, f2
    gc_env.f[2] = gc_env.f[4] * gc_env.f[2]; // fmul f2, f4, f2
    gc_env.f[0] = -(gc_env.f[5] * gc_env.f[0] - gc_env.f[3]); // fnmsub f0, f5, f0, f3
    gc_env.f[2] = gc_env.f[2] * gc_env.f[0]; // fmul f2, f2, f0
    gc_env.f[0] = gc_env.f[2] * gc_env.f[2]; // fmul f0, f2, f2
    gc_env.f[2] = gc_env.f[4] * gc_env.f[2]; // fmul f2, f4, f2
    gc_env.f[0] = -(gc_env.f[5] * gc_env.f[0] - gc_env.f[3]); // fnmsub f0, f5, f0, f3
    gc_env.f[2] = gc_env.f[2] * gc_env.f[0]; // fmul f2, f2, f0
    ...
    gc_env.f[2] = gc_env.f[4] * gc_env.f[2]; // fmul f2, f4, f2
    gc_env.f[0] = -(gc_env.f[5] * gc_env.f[0] - gc_env.f[3]); // fnmsub f0, f5, f0, f3
    gc_env.f[0] = gc_env.f[2] * gc_env.f[0]; // fmul f0, f2, f0
    gc_env.f[0] = gc_env.f[5] * gc_env.f[0]; // fmul f0, f5, f0
    gc_env.f[0] = (float)gc_env.f[0]; // frsp f0, f0
    float temp = (float)gc_env.f[0]; // stfs f0, 0x10(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x10, *(uint32_t*)&temp);
...
void Camera_8002BD88(void) {
    ...
    gc_mem_write64(gc_env.ram, gc_env.r[1] + 0x48, temp); // stfd f29, 0x48(r1)
    gc_env.f[29] = gc_env.f[1]; // fmr f29, f1
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x44, gc_env.r[31]); // stw r31, 0x44(r1)
    gc_env.r[31] = gc_env.r[5] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r31, r5, cm_80452C68@l
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x10, gc_env.r[4]); // stw r4, 0x10(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x14, gc_env.r[0]); // stw r0, 0x14(r1)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x328); // lwz r0, 0x328(r31)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x18, gc_env.r[0]); // stw r0, 0x18(r1)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x10); // lwz r0, 0x10(r1)
    ...
    gc_env.r[3] = gc_env.r[1] + 52; // addi r3, r1, 0x34
    lbVector_Normalize();
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x34); // lwz r3, 0x34(r1)
    ...
    uint64_t temp = gc_mem_read64(gc_env.ram, gc_env.r[1] + 0x48); // lfd f29, 0x48(r1)
    gc_env.f[29] = *(double*)&temp;
    gc_env.r[31] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x44); // lwz r31, 0x44(r1)
    gc_env.r[30] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x40); // lwz r30, 0x40(r1)
    gc_env.r[1] += 96; // addi r1, r1, 0x60
    gc_env.lr = gc_env.r[0]; // Move to link register
    return;
}
...
void Camera_8002C010(void) {
    ...
    gc_env.r[5] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r5, cm_80452C68@ha
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x58, gc_env.r[1]); // stwu r1, -0x58(r1)
...
void Camera_8002C1A8(void) {
    ...
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x68, gc_env.r[1]); // stwu r1, -0x68(r1)
    ...
    gc_env.r[31] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r31, r3, cm_80452C68@l
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x30, gc_env.r[30]); // stw r30, 0x30(r1)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x305); // lbz r0, 0x305(r31)
    gc_env.r[4] = (int32_t)(int8_t)(gc_env.r[0] & 0xFF); // extsb r4, r0
    gc_env.cr[0] = (gc_env.r[4] == 0x5) ? 0 : (gc_env.r[4] < 0x5 ? -1 : 1); // Compare with immediate
    if (gc_env.cr[0] == 0) goto L_8002C584;
    gc_env.r[3] = gc_env.r[1] + 16; // addi r3, r1, 0x10
    Camera_8002B694();
    gc_env.f[27] = cm_804D7E14; // lfs f27, cm_804D7E14@sda21(r0)
    gc_env.r[0] = 0x20; // li r0, 0x20
    gc_env.r[6] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x2C); // lwz r6, 0x2C(r1)
    gc_env.r[8] = 0x0; // li r8, 0x0
    ...
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x20); // lwz r0, 0x20(r1)
    gc_env.f[31] = gc_env.f[30]; // fmr f31, f30
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x24); // lwz r3, 0x24(r1)
    if (gc_env.cr[0] == 0) goto L_8002C254;
    gc_env.r[4] = 0x1; // li r4, 0x1
    goto L_8002C270;
    L_8002C254:
    gc_env.r[5] = 0x40; // li r5, 0x40
    gc_env.r[5] = gc_env.r[6] & gc_env.r[5];
    gc_env.r[6] = gc_env.r[5] ^ gc_env.r[8]; // xor r6, r5, r8
    gc_env.r[5] = gc_env.r[7] ^ gc_env.r[8]; // xor r5, r7, r8
    gc_env.r[5] = gc_env.r[6] | gc_env.r[5]; // or r5, r6, r5
    if (gc_env.cr[0] == 0) goto L_8002C270;
    gc_env.r[4] = -0x1; // li r4, -0x1
    L_8002C270:
    gc_env.r[5] = 0x8; // li r5, 0x8
    gc_env.r[8] = 0x0; // li r8, 0x0
    ...
    L_8002C33C:
    gc_env.r[6] = 0x100; // li r6, 0x100
    gc_env.r[5] = 0x0; // li r5, 0x0
    gc_env.r[3] = gc_env.r[3] & gc_env.r[6];
    gc_env.r[0] = gc_env.r[0] & gc_env.r[5];
    gc_env.r[3] = gc_env.r[3] ^ gc_env.r[5]; // xor r3, r3, r5
    gc_env.r[0] = gc_env.r[0] ^ gc_env.r[5]; // xor r0, r0, r5
    gc_env.r[0] = gc_env.r[3] | gc_env.r[0]; // or r0, r3, r0
    ...
    L_8002C374:
    gc_env.f[0] = cm_804D7EA0; // lfd f0, cm_804D7EA0@sda21(r0)
    gc_env.cr[0] = isnan(gc_env.f[1]) || isnan(gc_env.f[0]) ? 0x1 : (gc_env.f[1] < gc_env.f[0] ? 0x8 : (gc_env.f[1] > gc_env.f[0] ? 0x4 : 0x2)); // fcmpo cr0, f1, f0
    ...
    gc_env.f[0] = *(float*)&temp;
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x304); // lbz r3, 0x304(r31)
    gc_env.f[26] = (float)gc_env.f[2] * (float)gc_env.f[1] + (float)gc_env.f[0]; // fmadds f26, f2, f1, f0
    gc_env.r[3] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r3, r3
    Camera_8002BA00();
    gc_env.r[0] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r0, r3
    gc_mem_write8(gc_env.ram, gc_env.r[30] + 0x0, gc_env.r[0]); // stb r0, 0x0(r30)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[30] + 0x0); // lbz r0, 0x0(r30)
    gc_env.f[1] = cm_804D7E14; // lfs f1, cm_804D7E14@sda21(r0)
    ...
    L_8002C4E4:
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x304); // lbz r0, 0x304(r31)
    gc_env.cr[0] = (gc_env.r[0] == 0xa) ? 0 : (gc_env.r[0] < 0xa ? -1 : 1); // Compare with immediate
...
void Camera_8002C5B4(void) {
    ...
    gc_env.r[12] = gc_mem_read32(gc_env.ram, gc_env.r[3] + 0x30); // lwz r12, 0x30(r3)
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_env.r[31] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r31, r3, cm_80452C68@l
    ...
    gc_env.r[5] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x314); // lwz r5, 0x314(r31)
    gc_env.r[4] = gc_env.r[30]; // Move register
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x318); // lwz r0, 0x318(r31)
    gc_env.r[3] = gc_env.r[1] + 52; // addi r3, r1, 0x34
    ...
    gc_env.f[1] = 1.0 / sqrt(gc_env.f[4]); // frsqrte f1, f4
    gc_env.f[3] = cm_804D7E78; // lfd f3, cm_804D7E78@sda21(r0)
    gc_env.f[2] = cm_804D7E80; // lfd f2, cm_804D7E80@sda21(r0)
    gc_env.f[0] = gc_env.f[1] * gc_env.f[1]; // fmul f0, f1, f1
    gc_env.f[1] = gc_env.f[3] * gc_env.f[1]; // fmul f1, f3, f1
    gc_env.f[0] = -(gc_env.f[4] * gc_env.f[0] - gc_env.f[2]); // fnmsub f0, f4, f0, f2
    ...
    gc_env.f[0] = gc_env.f[4] * gc_env.f[0]; // fmul f0, f4, f0
    gc_env.f[0] = (float)gc_env.f[0]; // frsp f0, f0
    float temp = (float)gc_env.f[0]; // stfs f0, 0x10(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x10, *(uint32_t*)&temp);
    uint32_t temp = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x10); // lfs f0, 0x10(r1)
...
void Camera_8002C908(void) {
    ...
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x70, gc_env.r[1]); // stwu r1, -0x70(r1)
    ...
    goto L_8002C960;
    L_8002C948:
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0x0); // lbz r3, 0x0(r28)
    gc_env.r[4] = 0x1; // li r4, 0x1
    gc_env.r[3] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r3, r3
    Camera_8002BA00();
    gc_env.r[0] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r0, r3
    gc_mem_write8(gc_env.ram, gc_env.r[28] + 0x0, gc_env.r[0]); // stb r0, 0x0(r28)
    L_8002C960:
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0x0); // lbz r3, 0x0(r28)
    gc_env.r[29] = 0x1; // li r29, 0x1
    gc_env.r[3] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r3, r3
    gc_env.cr[0] = (gc_env.r[3] == 0xb) ? 0 : (gc_env.r[3] < 0xb ? -1 : 1); // Compare with immediate
    if (gc_env.cr[0] != 0) goto L_8002C97C;
    gc_env.r[29] = 0x0; // li r29, 0x0
    goto L_8002C9C8;
    L_8002C97C:
    ...
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x74); // lwz r0, 0x74(r1)
...
void Camera_8002CB0C(void) {
    ...
    gc_env.r[31] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r31, r3, cm_80452C68@l
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x2c5); // lbz r0, 0x2c5(r31)
    gc_env.r[4] = (int32_t)(int8_t)(gc_env.r[0] & 0xFF); // extsb r4, r0
    gc_env.cr[0] = (gc_env.r[4] == 0x5) ? 0 : (gc_env.r[4] < 0x5 ? -1 : 1); // Compare with immediate
    ...
    gc_env.r[0] = 0x20; // li r0, 0x20
    gc_env.r[6] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x34); // lwz r6, 0x34(r1)
    gc_env.r[5] = 0x0; // li r5, 0x0
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x30); // lwz r3, 0x30(r1)
    gc_env.f[31] = gc_env.f[30]; // fmr f31, f30
    gc_env.r[0] = gc_env.r[6] & gc_env.r[0];
    gc_env.r[4] = gc_env.r[3] & gc_env.r[5];
    uint32_t temp = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x18); // lfs f2, 0x18(r1)
    gc_env.f[2] = *(float*)&temp;
    gc_env.r[3] = gc_env.r[0] ^ gc_env.r[5]; // xor r3, r0, r5
    gc_env.r[0] = gc_env.r[4] ^ gc_env.r[5]; // xor r0, r4, r5
    ...
    gc_env.r[30] = 0x1; // li r30, 0x1
    goto L_8002CBB4;
    L_8002CB98:
    gc_env.r[0] = 0x40; // li r0, 0x40
    gc_env.r[0] = gc_env.r[6] & gc_env.r[0];
    gc_env.r[3] = gc_env.r[0] ^ gc_env.r[5]; // xor r3, r0, r5
    gc_env.r[0] = gc_env.r[4] ^ gc_env.r[5]; // xor r0, r4, r5
    gc_env.r[0] = gc_env.r[3] | gc_env.r[0]; // or r0, r3, r0
    ...
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x2c4); // lbz r3, 0x2c4(r31)
    gc_env.r[4] = gc_env.r[30] + 0; // addi r4, r30, 0x0
    gc_env.r[3] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r3, r3
    Camera_8002BA00();
    gc_env.r[0] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r0, r3
    ...
    gc_mem_write8(gc_env.ram, gc_env.r[28] + 0x0, gc_env.r[0]); // stb r0, 0x0(r28)
    L_8002CC8C:
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0x0); // lbz r0, 0x0(r28)
    gc_env.r[3] = (int32_t)(int8_t)(gc_env.r[0] & 0xFF); // extsb r3, r0
    gc_env.cr[0] = (gc_env.r[3] == 0xa) ? 0 : (gc_env.r[3] < 0xa ? -1 : 1); // Compare with immediate
    ...
    gc_env.cr[0] = (gc_env.r[3] == 0x0) ? 0 : (gc_env.r[3] < 0x0 ? -1 : 1); // Compare with immediate
    if (gc_env.cr[0] != 0) goto L_8002CC74;
    gc_env.r[29] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0x0); // lbz r29, 0x0(r28)
    gc_env.r[29] = (int32_t)(int8_t)(gc_env.r[29] & 0xFF); // extsb r29, r29
...
void Camera_8002CDDC(void) {
    ...
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0xb8, gc_env.r[1]); // stwu r1, -0xb8(r1)
    ...
    Camera_8002958C();
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x2c4); // lbz r0, 0x2c4(r31)
    ...
    goto L_8002CE40;
    L_8002CE28:
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[29] + 0x0); // lbz r3, 0x0(r29)
    gc_env.r[4] = 0x1; // li r4, 0x1
    gc_env.r[3] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r3, r3
    Camera_8002BA00();
    gc_env.r[0] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r0, r3
    ...
    gc_env.cr[0] = (gc_env.r[3] == 0xb) ? 0 : (gc_env.r[3] < 0xb ? -1 : 1); // Compare with immediate
    gc_env.r[28] = 0x1; // li r28, 0x1
    if (gc_env.cr[0] != 0) goto L_8002CE64;
    gc_env.r[28] = 0x0; // li r28, 0x0
    goto L_8002CEB0;
    L_8002CE64:
    gc_env.cr[0] = (gc_env.r[3] == 0xa) ? 0 : (gc_env.r[3] < 0xa ? -1 : 1); // Compare with immediate
    ...
    gc_env.cr[0] = (gc_env.r[3] == 0x0) ? 0 : (gc_env.r[3] < 0x0 ? -1 : 1); // Compare with immediate
    if (gc_env.cr[0] == 0) goto L_8002D078;
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[26] + 0x8); // lwz r0, 0x8(r26)
    gc_env.cr[0] = (gc_env.r[0] == 0x0) ? 0 : (gc_env.r[0] < 0x0 ? -1 : 1); // Compare with immediate
    if (gc_env.cr[0] != 0) goto L_8002D078;
    ...
    float temp = (float)gc_env.f[0]; // stfs f0, 0x2B4(r31)
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x2B4, *(uint32_t*)&temp);
    gc_mem_write16(gc_env.ram, gc_env.r[26] + 0x0, gc_env.r[0]); // sth r0, 0x0(r26)
    L_8002D2AC:
    Stage_GetCamBoundsLeftOffset();
    gc_env.f[31] = gc_env.f[1]; // fmr f31, f1
    Stage_GetCamBoundsRightOffset();
    ...
    gc_env.r[3] += 1; // addi r3, r3, 0x1
    gc_mem_write16(gc_env.ram, gc_env.r[26] + 0x0, gc_env.r[3]); // sth r3, 0x0(r26)
    gc_env.r[3] = (int32_t)(int16_t)gc_mem_read16(gc_env.ram, gc_env.r[26] + 0x0); // lha r3, 0x0(r26)
    gc_env.f[1] = cm_804D7E20; // lfd f1, cm_804D7E20@sda21(r0)
    gc_env.r[3] = gc_env.r[3] ^ 0x80000000; // xoris r3, r3, 0x8000
    uint32_t temp = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x2B4); // lfs f2, 0x2B4(r31)
    gc_env.f[2] = *(float*)&temp;
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x94, gc_env.r[3]); // stw r3, 0x94(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x90, gc_env.r[0]); // stw r0, 0x90(r1)
...
void Camera_8002D318(void) {
    ...
    uint32_t temp = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x2B4); // lfs f2, 0x2B4(r31)
    gc_env.f[2] = *(float*)&temp;
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x84, gc_env.r[3]); // stw r3, 0x84(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x80, gc_env.r[0]); // stw r0, 0x80(r1)
...
void Camera_8002DFE4(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x48, gc_env.r[1]); // stwu r1, -0x48(r1)
    ...
    gc_env.r[29] = gc_env.r[3] + 0; // addi r29, r3, 0x0
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[6] + 0x341); // lbz r0, 0x341(r6)
    ...
    gc_env.f[0] = cm_804D7E04; // lfs f0, cm_804D7E04@sda21(r0)
    gc_env.cr[0] = isnan(gc_env.f[1]) || isnan(gc_env.f[0]) ? 0x1 : (gc_env.f[1] < gc_env.f[0] ? 0x8 : (gc_env.f[1] > gc_env.f[0] ? 0x4 : 0x2)); // fcmpo cr0, f1, f0
    gc_env.cr[0] = (gc_env.cr[0] & ~(1 << 2)) | ((((gc_env.cr[0] >> 1) & 1) | ((gc_env.cr[0] >> 2) & 1)) << 2); // cror eq, gt, eq
...
void Camera_8002E158(void) {
    ...
    gc_env.r[1] = gc_env.r[1] + -0x28;
    gc_env.r[4] = gc_env.r[4] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r4, r4, cm_80452C68@l
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[4] + 0x341); // lbz r0, 0x341(r4)
    gc_env.r[6] = 0x0; // li r6, 0x0
    gc_env.r[0] = (gc_env.r[0] >> 1) & 0x3; // extrwi r0, r0, 2, 29
    gc_env.cr[0] = (gc_env.r[0] == 0x1) ? 0 : (gc_env.r[0] < 0x1 ? -1 : 1); // Compare with immediate
    ...
    gc_env.f[4] = cm_804D7E20; // lfd f4, cm_804D7E20@sda21(r0)
    gc_env.r[0] = gc_env.r[0] ^ 0x80000000; // xoris r0, r0, 0x8000
...
void Camera_8002E234(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x1C, *(uint32_t*)&temp);
    lbVector_Add();
    gc_env.r[5] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x14); // lwz r5, 0x14(r1)
    gc_env.r[3] = gc_env.r[1] + 20; // addi r3, r1, 0x14
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x18); // lwz r0, 0x18(r1)
    gc_env.r[4] = 0x1; // li r4, 0x1
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x38, gc_env.r[5]); // stw r5, 0x38(r31)
...
void Camera_8002E490(void) {
    ...
    goto L_8002E53C;
    L_8002E4E8:
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x344); // lwz r3, 0x344(r31)
    Player_GetEntity();
    gc_env.cr[0] = ((uint32_t)gc_env.r[3] == 0x0) ? 0 : ((uint32_t)gc_env.r[3] < 0x0 ? -1 : 1); // Logical compare with immediate
    if (gc_env.cr[0] == 0) goto L_8002E574;
    ftLib_80086B74();
    ...
    goto L_8002E574;
    L_8002E53C:
    gc_env.r[12] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x344); // lwz r12, 0x344(r31)
    gc_env.cr[0] = ((uint32_t)gc_env.r[12] == 0x0) ? 0 : ((uint32_t)gc_env.r[12] < 0x0 ? -1 : 1); // Logical compare with immediate
    if (gc_env.cr[0] == 0) goto L_8002E574;
    gc_env.lr = gc_env.r[12]; // Move to link register
    gc_env.r[3] = gc_env.r[1] + 28; // addi r3, r1, 0x1c
...
void Camera_8002E6FC(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x344, gc_env.r[30]); // stw r30, 0x344(r31)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x341); // lbz r0, 0x341(r31)
    gc_env.r[0] = (gc_env.r[0] >> 5) & 0x3; // extrwi r0, r0, 2, 25
    gc_env.cr[0] = (gc_env.r[0] == 0x2) ? 0 : (gc_env.r[0] < 0x2 ? -1 : 1); // Compare with immediate
...
void Camera_8002EB5C(void) {
    ...
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x341); // lbz r3, 0x341(r31)
    ...
    gc_mem_write8(gc_env.ram, gc_env.r[4] + 0x0, gc_env.r[3]); // stb r3, 0x0(r4)
    gc_env.r[3] = 0x0; // li r3, 0x0
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x35c); // lbz r0, 0x35c(r31)
    uint32_t rotated = gc_env.r[3] << 7; // rlwimi r0, r3, 7, 24, 24
    gc_env.r[0] = (gc_env.r[0] & ~0x80) | (rotated & 0x80);
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x35c, gc_env.r[0]); // stb r0, 0x35c(r31)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x35c); // lbz r0, 0x35c(r31)
    uint32_t rotated = gc_env.r[3] << 5; // rlwimi r0, r3, 5, 26, 26
    gc_env.r[0] = (gc_env.r[0] & ~0x20) | (rotated & 0x20);
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x35c, gc_env.r[0]); // stb r0, 0x35c(r31)
...
void Camera_8002ED9C(void) {
    ...
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x35c, gc_env.r[0]); // stb r0, 0x35c(r31)
    L_8002EE08:
    gc_env.f[0] = (double)(int32_t)gc_env.f[31]; // fctiwz f0, f31
    gc_env.r[5] = gc_env.r[31] + 860; // addi r5, r31, 0x35c
    gc_env.r[3] = 0x1; // li r3, 0x1
    uint64_t temp;
    memcpy(&temp, &gc_env.f[0], sizeof(double));
...
void Camera_8002F0E4(void) {
    ...
    goto L_8002F170;
    L_8002F158:
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x14); // lwz r3, 0x14(r31)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x18); // lwz r0, 0x18(r31)
    ...
    gc_env.f[1] = (float)gc_env.f[2] + (float)gc_env.f[0]; // fadds f1, f2, f0
    sqrtf__Ff();
    gc_env.f[0] = (double)(int32_t)gc_env.f[1]; // fctiwz f0, f1
    uint64_t temp;
    memcpy(&temp, &gc_env.f[0], sizeof(double));
    gc_mem_write64(gc_env.ram, gc_env.r[1] + 0x20, temp); // stfd f0, 0x20(r1)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x24); // lwz r0, 0x24(r1)
    gc_mem_write16(gc_env.ram, gc_env.r[31] + 0x368, gc_env.r[0]); // sth r0, 0x368(r31)
...
void Camera_8002F260(void) {
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_env.r[3] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r3, r3, cm_80452C68@l
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0x341); // lbz r3, 0x341(r3)
...
void fn_8002F360(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x8, gc_env.r[1]); // stwu r1, -0x8(r1)
    gc_env.r[1] = gc_env.r[1] + -0x8;
    gc_env.r[5] = gc_mem_read32(gc_env.ram, gc_env.r[4] + 0x4); // lwz r5, 0x4(r4)
    gc_env.r[4] = ((uint32_t)&cm_803BCB18 >> 16) & 0xFFFF; // lis r4, cm_803BCB18@ha
...
void Camera_8002F3AC(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x34, gc_env.r[0]); // stw r0, 0x34(r31)
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x20); // lwz r3, 0x20(r31)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x24); // lwz r0, 0x24(r31)
    ...
    float temp = (float)gc_env.f[0]; // stfs f0, 0x44(r31)
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x44, *(uint32_t*)&temp);
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x70); // lwz r3, 0x70(r31)
    gc_env.r[0] = gc_mem_read32(gc_env.ram, gc_env.r[31] + 0x74); // lwz r0, 0x74(r31)
...
void Camera_8002F4D4(void) {
    ...
    L_8002F508:
    gc_env.r[0] = gc_env.r[3] - 10; // subi r0, r3, 10
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x4, gc_env.r[0]); // stw r0, 0x4(r31)
    gc_env.r[29] = gc_env.r[31] + 708; // addi r29, r31, 0x2c4
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x2c4, gc_env.r[3]); // stb r3, 0x2c4(r31)
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x2c5, gc_env.r[4]); // stb r4, 0x2c5(r31)
    Stage_GetCamBoundsLeftOffset();
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x300, gc_env.r[0]); // stw r0, 0x300(r31)
    ...
    gc_env.r[4] = 0xedf; // li r4, 0xedf
    gc_env.r[5] = (uint32_t)&cm_804D3938; // li r5, cm_804D3938@sda21
    __assert();
    L_8002F608:
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[29] + 0x0); // lbz r3, 0x0(r29)
    gc_env.r[3] = (int32_t)(int8_t)(gc_env.r[3] & 0xFF); // extsb r3, r3
...
void Camera_8002F784(void) {
    ...
    gc_env.r[0] = 0x2; // li r0, 0x2
    gc_mem_write32(gc_env.ram, gc_env.r[5] + 0x4, gc_env.r[0]); // stw r0, 0x4(r5)
    gc_mem_write8(gc_env.ram, gc_env.r[5] + 0x2c4, gc_env.r[3]); // stb r3, 0x2c4(r5)
    gc_mem_write8(gc_env.ram, gc_env.r[5] + 0x2c5, gc_env.r[4]); // stb r4, 0x2c5(r5)
    gc_env.f[0] = cm_804D7E14; // lfs f0, cm_804D7E14@sda21(r0)
...
void Camera_8002F7AC(void) {
    ...
    goto L_8002F834;
    L_8002F830:
    gc_env.f[0] = cm_804D7EB8; // lfd f0, cm_804D7EB8@sda21(r0)
    L_8002F834:
    ...
    L_8002F890:
    HSD_Randf();
    gc_env.f[2] = cm_804D7EC8; // lfd f2, cm_804D7EC8@sda21(r0)
    gc_env.f[0] = cm_804D7ED0; // lfd f0, cm_804D7ED0@sda21(r0)
    gc_env.f[0] = gc_env.f[2] * gc_env.f[1] - gc_env.f[0]; // fmsub f0, f2, f1, f0
    gc_env.f[0] = (float)gc_env.f[0]; // frsp f0, f0
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x2C8, *(uint32_t*)&temp);
    HSD_Randf();
    gc_env.f[2] = cm_804D7ED8; // lfd f2, cm_804D7ED8@sda21(r0)
    gc_env.f[0] = cm_804D7EE0; // lfd f0, cm_804D7EE0@sda21(r0)
    gc_env.f[0] = gc_env.f[2] * gc_env.f[1] - gc_env.f[0]; // fmsub f0, f2, f1, f0
    gc_env.f[0] = (float)gc_env.f[0]; // frsp f0, f0
    float temp = (float)gc_env.f[0]; // stfs f0, 0x2CC(r31)
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x2CC, *(uint32_t*)&temp);
...
void Camera_8002F9E4(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_env.r[5] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r5, cm_80452C68@ha
    gc_env.r[0] = 0x5; // li r0, 0x5
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x28, gc_env.r[1]); // stwu r1, -0x28(r1)
    gc_env.r[1] = gc_env.r[1] + -0x28;
    gc_env.r[3] = gc_env.r[3] - 1; // subi r3, r3, 1
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x14, gc_env.r[27]); // stmw r27, 0x14(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x18, gc_env.r[28]); // stmw r27, 0x14(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x1C, gc_env.r[29]); // stmw r27, 0x14(r1)
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x20, gc_env.r[30]); // stmw r27, 0x14(r1)
    ...
    gc_mem_write8(gc_env.ram, gc_env.r[30] + 0x304, gc_env.r[0]); // stb r0, 0x304(r30)
    gc_env.r[3] = ((uint32_t)&cm_803BCCA0 >> 16) & 0xFFFF; // lis r3, cm_803BCCA0@ha
    gc_env.r[31] = gc_env.r[3] + ((uint32_t)&cm_803BCCA0 & 0xFFFF); // addi r31, r3, cm_803BCCA0@l
    gc_mem_write8(gc_env.ram, gc_env.r[30] + 0x305, gc_env.r[27]); // stb r27, 0x305(r30)
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[30] + 0x300, gc_env.r[0]); // stw r0, 0x300(r30)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0x0); // lbz r0, 0x0(r28)
    gc_env.f[1] = cm_804D7E14; // lfs f1, cm_804D7E14@sda21(r0)
    gc_env.cr[0] = (gc_env.r[0] == 0xa) ? 0 : (gc_env.r[0] < 0xa ? -1 : 1); // Compare with immediate
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[30] + 0x24, gc_env.r[0]); // stw r0, 0x24(r30)
...
void Camera_8002FE38(void) {
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_env.r[4] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r4, r3, cm_80452C68@l
    gc_env.r[0] = 0x6; // li r0, 0x6
    gc_mem_write32(gc_env.ram, gc_env.r[4] + 0x4, gc_env.r[0]); // stw r0, 0x4(r4)
    gc_env.r[3] = 0x0; // li r3, 0x0
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[4] + 0x341); // lbz r0, 0x341(r4)
    uint32_t rotated = gc_env.r[3] << 5; // rlwimi r0, r3, 5, 25, 26
    gc_env.r[0] = (gc_env.r[0] & ~0x60) | (rotated & 0x60);
    gc_mem_write8(gc_env.ram, gc_env.r[4] + 0x341, gc_env.r[0]); // stb r0, 0x341(r4)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[4] + 0x341); // lbz r0, 0x341(r4)
    uint32_t rotated = gc_env.r[3] << 3; // rlwimi r0, r3, 3, 27, 28
    gc_env.r[0] = (gc_env.r[0] & ~0x18) | (rotated & 0x18);
    gc_mem_write8(gc_env.ram, gc_env.r[4] + 0x341, gc_env.r[0]); // stb r0, 0x341(r4)
    ...
    gc_env.r[0] = (gc_env.r[0] & ~0x1) | (rotated & 0x1);
    gc_mem_write8(gc_env.ram, gc_env.r[4] + 0x341, gc_env.r[0]); // stb r0, 0x341(r4)
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[4] + 0x14); // lwz r3, 0x14(r4)
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[4] + 0x20, gc_env.r[3]); // stw r3, 0x20(r4)
...
void Camera_8003019C(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x8, gc_env.r[1]); // stwu r1, -0x8(r1)
    gc_env.r[1] = gc_env.r[1] + -0x8;
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[3] + 0x4); // lwz r3, 0x4(r3)
    Player_GetEntity();
    ftLib_80086B74();
...
void fn_800301D0(void) {
    ...
    gc_env.r[29] = gc_env.r[3]; // Move register
    gc_env.r[27] = gc_mem_read32(gc_env.ram, gc_env.r[3] + 0x28); // lwz r27, 0x28(r3)
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    ...
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0x399); // lbz r3, 0x399(r28)
    gc_env.r[3] = gc_env.r[3] & 0x1; // clrlwi r3, r3, 31
    lbShadow_8000F38C();
    gc_env.r[3] = gc_env.r[27]; // Move register
    HSD_CObjSetCurrent();
    ...
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0x398); // lbz r0, 0x398(r28)
    ...
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0x8); // lbz r3, 0x8(r28)
    gc_env.r[6] = 0xff; // li r6, 0xff
    gc_env.r[4] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0x9); // lbz r4, 0x9(r28)
    gc_env.r[5] = gc_mem_read8(gc_env.ram, gc_env.r[28] + 0xa); // lbz r5, 0xa(r28)
    HSD_SetEraseColor();
    goto L_8003025C;
    L_80030248:
    gc_env.r[3] = 0x0; // li r3, 0x0
    ...
    gc_env.r[3] = 0x2; // li r3, 0x2
    Camera_800310A0();
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x0); // lbz r0, 0x0(r31)
    gc_env.r[0] = (gc_env.r[0] >> 5) & 0x1; // extrwi r0, r0, 1, 26
    gc_env.cr[0] = (gc_env.r[0] == 0) ? 0x2 : ((int32_t)gc_env.r[0] < 0 ? 0x8 : 0x4);
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[29] + 0x24, gc_env.r[0]); // stw r0, 0x24(r29)
    gc_env.r[0] = gc_env.r[5] | gc_env.r[3]; // or r0, r5, r3
    gc_env.r[3] = gc_env.r[29] + 0; // addi r3, r29, 0x0
    gc_mem_write32(gc_env.ram, gc_env.r[29] + 0x20, gc_env.r[0]); // stw r0, 0x20(r29)
    gc_env.r[4] = 0x7; // li r4, 0x7
    HSD_GObj_80390ED0();
    gc_env.r[3] = 0x1; // li r3, 0x1
    Camera_800310A0();
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x0); // lbz r0, 0x0(r31)
    ...
    goto L_8003030C;
    L_80030304:
    gc_env.r[3] = 0x8; // li r3, 0x8
    gc_env.r[0] = 0x0; // li r0, 0x0
    L_8003030C:
    gc_mem_write32(gc_env.ram, gc_env.r[29] + 0x24, gc_env.r[3]); // stw r3, 0x24(r29)
    gc_env.r[3] = gc_env.r[29] + 0; // addi r3, r29, 0x0
    gc_env.r[4] = 0x7; // li r4, 0x7
    gc_mem_write32(gc_env.ram, gc_env.r[29] + 0x20, gc_env.r[0]); // stw r0, 0x20(r29)
    HSD_GObj_80390ED0();
...
void Camera_800304E0(void) {
    ...
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[30] + 0x8); // lbz r3, 0x8(r30)
    gc_env.r[6] = 0x1; // li r6, 0x1
    gc_env.r[4] = gc_mem_read8(gc_env.ram, gc_env.r[30] + 0x9); // lbz r4, 0x9(r30)
    gc_env.r[5] = gc_mem_read8(gc_env.ram, gc_env.r[30] + 0xa); // lbz r5, 0xa(r30)
    HSD_SetEraseColor();
    gc_env.r[3] = gc_env.r[29] + 0; // addi r3, r29, 0x0
    gc_env.r[4] = 0x1; // li r4, 0x1
    gc_env.r[5] = 0x0; // li r5, 0x0
    ...
    gc_env.r[0] = gc_env.r[5] | gc_env.r[3]; // or r0, r5, r3
    gc_env.r[3] = gc_env.r[31] + 0; // addi r3, r31, 0x0
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x20, gc_env.r[0]); // stw r0, 0x20(r31)
    gc_env.r[4] = 0x7; // li r4, 0x7
    HSD_GObj_80390ED0();
    gc_env.r[3] = 0x1; // li r3, 0x1
    Camera_800310A0();
    ...
    gc_env.r[0] = 0x0; // li r0, 0x0
    L_800305DC:
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x24, gc_env.r[3]); // stw r3, 0x24(r31)
    gc_env.r[3] = gc_env.r[31] + 0; // addi r3, r31, 0x0
    gc_env.r[4] = 0x7; // li r4, 0x7
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x20, gc_env.r[0]); // stw r0, 0x20(r31)
    HSD_GObj_80390ED0();
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x20, gc_env.r[0]); // stw r0, 0x20(r31)
    HSD_GObj_80390ED0();
    gc_env.r[0] = 0x70; // li r0, 0x70
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x24, gc_env.r[0]); // stw r0, 0x24(r31)
    gc_env.r[30] = 0x0; // li r30, 0x0
    gc_env.r[3] = gc_env.r[31] + 0; // addi r3, r31, 0x0
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x20, gc_env.r[30]); // stw r30, 0x20(r31)
    gc_env.r[4] = 0x7; // li r4, 0x7
    HSD_GObj_80390ED0();
    gc_env.r[3] = 0x0; // li r3, 0x0
    HSD_FogSet();
    gc_env.r[0] = 0x80; // li r0, 0x80
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x24, gc_env.r[0]); // stw r0, 0x24(r31)
    gc_env.r[3] = gc_env.r[31] + 0; // addi r3, r31, 0x0
    gc_env.r[4] = 0x7; // li r4, 0x7
    gc_mem_write32(gc_env.ram, gc_env.r[31] + 0x20, gc_env.r[30]); // stw r30, 0x20(r31)
...
void Camera_80030688(void) {
    gc_env.r[0] = gc_env.lr; // Move from link register
    gc_env.r[3] = 0x10; // li r3, 0x10
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x4, gc_env.r[0]); // stw r0, 0x4(r1)
    gc_env.r[4] = 0x12; // li r4, 0x12
    gc_env.r[5] = 0x0; // li r5, 0x0
    gc_mem_write32(gc_env.ram, gc_env.r[1] + -0x18, gc_env.r[1]); // stwu r1, -0x18(r1)
    gc_env.r[1] = gc_env.r[1] + -0x18;
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x14, gc_env.r[31]); // stw r31, 0x14(r1)
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[5] + (uint32_t)&cm_80452C68, gc_env.r[30]); // stw r30, cm_80452C68@l/h(r5)
    gc_env.r[3] = gc_env.r[31]; // Move register
    lb_80013B14();
    gc_env.r[29] = gc_env.r[3] + 0; // addi r29, r3, 0x0
    gc_env.r[3] = gc_env.r[31] + 0; // addi r3, r31, 0x0
    ...
    gc_env.r[4] = gc_mem_read8(gc_env.ram, (uint32_t)&HSD_GObj_804D784B); // lbz r4, HSD_GObj_804D784B@sda21(r0)
    gc_env.r[3] = gc_env.r[30]; // Move register
...
void Camera_80030740(void) {
    gc_env.r[6] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r6, cm_80452C68@ha
    gc_env.r[6] = gc_env.r[6] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r6, r6, cm_80452C68@l
    gc_mem_write8(gc_env.ram, gc_env.r[6] + 0x8, gc_env.r[3]); // stb r3, 0x8(r6)
    gc_mem_write8(gc_env.ram, gc_env.r[6] + 0x9, gc_env.r[4]); // stb r4, 0x9(r6)
    gc_mem_write8(gc_env.ram, gc_env.r[6] + 0xa, gc_env.r[5]); // stb r5, 0xa(r6)
    return;
}
...
void Camera_80030758(void) {
    ...
    gc_env.r[3] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r3, r3, cm_80452C68@l
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0x8); // lbz r0, 0x8(r3)
    gc_mem_write8(gc_env.ram, gc_env.r[1] + 0x8, gc_env.r[0]); // stb r0, 0x8(r1)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0x9); // lbz r0, 0x9(r3)
    gc_mem_write8(gc_env.ram, gc_env.r[1] + 0x9, gc_env.r[0]); // stb r0, 0x9(r1)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0xa); // lbz r0, 0xa(r3)
    gc_mem_write8(gc_env.ram, gc_env.r[1] + 0xa, gc_env.r[0]); // stb r0, 0xa(r1)
    gc_env.r[3] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x8); // lwz r3, 0x8(r1)
...
void Camera_800307D0(void) {
    ...
    gc_env.f[1] = -gc_env.f[1]; // fneg f1, f1
    L_8003086C:
    gc_env.f[0] = cm_804D7EE8; // lfd f0, cm_804D7EE8@sda21(r0)
    gc_env.cr[0] = isnan(gc_env.f[1]) || isnan(gc_env.f[0]) ? 0x1 : (gc_env.f[1] < gc_env.f[0] ? 0x8 : (gc_env.f[1] > gc_env.f[0] ? 0x4 : 0x2)); // fcmpo cr0, f1, f0
    ...
    gc_env.f[0] = cm_804D7EF0; // lfd f0, cm_804D7EF0@sda21(r0)
    gc_env.cr[0] = isnan(gc_env.f[1]) || isnan(gc_env.f[0]) ? 0x1 : (gc_env.f[1] < gc_env.f[0] ? 0x8 : (gc_env.f[1] > gc_env.f[0] ? 0x4 : 0x2)); // fcmpo cr0, f1, f0
    if (gc_env.cr[0] & (0x8 | 0x2)) goto L_80030954; // ble .L_80030954
    uint32_t temp = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x38); // lfs f1, 0x38(r1)
    gc_env.f[1] = *(float*)&temp;
...
void Camera_80030A60(void) {
    gc_env.r[4] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r4, cm_80452C68@ha
    gc_env.r[4] = gc_env.r[4] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r4, r4, cm_80452C68@l
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[4] + 0x399); // lbz r0, 0x399(r4)
    uint32_t rotated = gc_env.r[3] << 4; // rlwimi r0, r3, 4, 27, 27
    gc_env.r[0] = (gc_env.r[0] & ~0x10) | (rotated & 0x10);
    gc_mem_write8(gc_env.ram, gc_env.r[4] + 0x399, gc_env.r[0]); // stb r0, 0x399(r4)
    return;
}
...
void Camera_80030A78(void) {
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_env.r[3] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r3, r3, cm_80452C68@l
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0x399); // lbz r3, 0x399(r3)
...
void Camera_80030AA4(void) {
    uint32_t val = gc_env.r[3]; int count = 0; while (val && !(val & 0x80000000)) { val <<= 1; count++; } gc_env.r[0] = count; // cntlzw r0, r3
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_env.r[3] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r3, r3, cm_80452C68@l
    gc_env.r[4] = (gc_env.r[0] >> 5) & 0xFF; // extrwi r4, r0, 8, 19
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0x399); // lbz r0, 0x399(r3)
    uint32_t rotated = gc_env.r[4] << 2; // rlwimi r0, r4, 2, 29, 29
    gc_env.r[0] = (gc_env.r[0] & ~0x4) | (rotated & 0x4);
    gc_mem_write8(gc_env.ram, gc_env.r[3] + 0x399, gc_env.r[0]); // stb r0, 0x399(r3)
    return;
}
...
void Camera_80030AC4(void) {
    ...
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0x399); // lbz r0, 0x399(r3)
    gc_env.r[0] = (gc_env.r[0] >> 2) & 0x1; // extrwi r0, r0, 1, 29
    uint32_t val = gc_env.r[0]; int count = 0; while (val && !(val & 0x80000000)) { val <<= 1; count++; } gc_env.r[0] = count; // cntlzw r0, r0
...
void Camera_80030B38(void) {
    gc_env.r[4] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r4, cm_80452C68@ha
    gc_env.r[4] = gc_env.r[4] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r4, r4, cm_80452C68@l
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[4] + 0x39a); // lbz r0, 0x39a(r4)
    uint32_t rotated = gc_env.r[3] << 7; // rlwimi r0, r3, 7, 24, 24
    gc_env.r[0] = (gc_env.r[0] & ~0x80) | (rotated & 0x80);
    gc_mem_write8(gc_env.ram, gc_env.r[4] + 0x39a, gc_env.r[0]); // stb r0, 0x39a(r4)
    return;
}
...
void Camera_80030B50(void) {
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_env.r[3] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r3, r3, cm_80452C68@l
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0x39a); // lbz r3, 0x39a(r3)
...
void Camera_80030BBC(void) {
    ...
    goto L_80030CB8;
    L_80030C48:
    gc_env.f[1] = (double)(int32_t)gc_env.f[2]; // fctiwz f1, f2
    gc_env.cr[0] = ((uint32_t)gc_env.r[28] == 0x0) ? 0 : ((uint32_t)gc_env.r[28] < 0x0 ? -1 : 1); // Logical compare with immediate
    gc_env.f[0] = (double)(int32_t)gc_env.f[3]; // fctiwz f0, f3
    uint64_t temp;
    ...
    HSD_CObjGetScissor();
    gc_env.r[0] = gc_mem_read16(gc_env.ram, gc_env.r[1] + 0x20); // lhz r0, 0x20(r1)
    ...
    gc_env.r[0] = gc_mem_read16(gc_env.ram, gc_env.r[1] + 0x22); // lhz r0, 0x22(r1)
    gc_env.cr[0] = (int32_t)gc_env.r[30] < (int32_t)gc_env.r[0] ? 0x8 : ((int32_t)gc_env.r[30] > (int32_t)gc_env.r[0] ? 0x4 : 0x2); // cmpw r30, r0
    if (gc_env.cr[0] >= 0) goto L_80030CAC;
    gc_env.r[0] = gc_mem_read16(gc_env.ram, gc_env.r[1] + 0x24); // lhz r0, 0x24(r1)
    gc_env.cr[0] = (int32_t)gc_env.r[29] < (int32_t)gc_env.r[0] ? 0x8 : ((int32_t)gc_env.r[29] > (int32_t)gc_env.r[0] ? 0x4 : 0x2); // cmpw r29, r0
    if (gc_env.cr[0] & 0x8) goto L_80030CAC; // blt .L_80030CAC
    gc_env.r[0] = gc_mem_read16(gc_env.ram, gc_env.r[1] + 0x26); // lhz r0, 0x26(r1)
    gc_env.cr[0] = (int32_t)gc_env.r[29] < (int32_t)gc_env.r[0] ? 0x8 : ((int32_t)gc_env.r[29] > (int32_t)gc_env.r[0] ? 0x4 : 0x2); // cmpw r29, r0
...
void Camera_80030CFC(void) {
    ...
    gc_env.r[30] = gc_env.r[3] + 0; // addi r30, r3, 0x0
    gc_env.r[5] = gc_mem_read32(gc_env.ram, gc_env.r[4] + (uint32_t)&cm_80452C68); // lwz r5, cm_80452C68@l/h(r4)
    ...
    gc_env.f[31] = *(double*)&temp;
    gc_env.r[31] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x64); // lwz r31, 0x64(r1)
    gc_env.r[30] = gc_mem_read32(gc_env.ram, gc_env.r[1] + 0x60); // lwz r30, 0x60(r1)
    gc_env.r[1] += 112; // addi r1, r1, 0x70
    gc_env.lr = gc_env.r[0]; // Move to link register
    return;
}
...
void Camera_80030E44(void) {
    ...
    gc_env.r[29] = gc_env.r[4] + 0; // addi r29, r4, 0x0
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x10, gc_env.r[28]); // stw r28, 0x10(r1)
    gc_env.r[28] = gc_env.r[3] + 0; // addi r28, r3, 0x0
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[30], gc_env.r[3]); // stw r3, (r30)
    L_80030EB4:
    gc_env.r[4] = 0xa; // li r4, 0xa
    goto L_80030EE8;
    L_80030EBC:
    gc_env.r[3] = gc_env.r[28]; // Move register
    grLib_801C9CEC();
    gc_env.r[4] = 0x16; // li r4, 0x16
    goto L_80030EE8;
    L_80030ECC:
    gc_env.r[3] = gc_env.r[28]; // Move register
    grLib_801C9CEC();
    ...
    gc_env.r[3] = gc_env.r[31] + gc_env.r[0]; // add r3, r31, r0
...
void Camera_80031044(void) {
    ...
    gc_env.r[3] = gc_env.r[4] + gc_env.r[0]; // add r3, r4, r0
    gc_env.r[0] = 0x0; // li r0, 0x0
...
void Camera_80031060(void) {
    gc_env.r[3] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r3, cm_80452C68@ha
    gc_env.r[3] = gc_env.r[3] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r3, r3, cm_80452C68@l
    gc_env.r[3] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0x398); // lbz r3, 0x398(r3)
...
void Camera_80031074(void) {
    gc_env.r[4] = ((uint32_t)&cm_80452C68 >> 16) & 0xFFFF; // lis r4, cm_80452C68@ha
    gc_env.r[4] = gc_env.r[4] + ((uint32_t)&cm_80452C68 & 0xFFFF); // addi r4, r4, cm_80452C68@l
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[4] + 0x398); // lbz r0, 0x398(r4)
    uint32_t rotated = gc_env.r[3] << 0; // rlwimi r0, r3, 0, 30, 31
    gc_env.r[0] = (gc_env.r[0] & ~0x3) | (rotated & 0x3);
    gc_mem_write8(gc_env.ram, gc_env.r[4] + 0x398, gc_env.r[0]); // stb r0, 0x398(r4)
    return;
}
...
void Camera_800310E8(void) {
    ...
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[3] + 0x398); // lbz r0, 0x398(r3)
    gc_env.r[3] = 0x0; // li r3, 0x0
    uint32_t rotated = gc_env.r[3] << 7; // rlwimi r0, r3, 7, 24, 24
    gc_env.r[0] = (gc_env.r[0] & ~0x80) | (rotated & 0x80);
    gc_mem_write8(gc_env.ram, gc_env.r[4] + 0x0, gc_env.r[0]); // stb r0, 0x0(r4)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[4] + 0x0); // lbz r0, 0x0(r4)
    uint32_t rotated = gc_env.r[3] << 6; // rlwimi r0, r3, 6, 25, 25
    gc_env.r[0] = (gc_env.r[0] & ~0x40) | (rotated & 0x40);
    gc_mem_write8(gc_env.ram, gc_env.r[4] + 0x0, gc_env.r[0]); // stb r0, 0x0(r4)
...
void Camera_800311EC(void) {
    ...
    gc_env.r[0] = (gc_env.r[0] & ~0x3) | (rotated & 0x3);
    gc_mem_write8(gc_env.ram, gc_env.r[31] + 0x0, gc_env.r[0]); // stb r0, 0x0(r31)
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x0); // lbz r0, 0x0(r31)
    gc_env.r[0] = (gc_env.r[0] >> 6) & 0x1; // extrwi r0, r0, 1, 25
    gc_env.cr[0] = (gc_env.r[0] == 0) ? 0x2 : ((int32_t)gc_env.r[0] < 0 ? 0x8 : 0x4);
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[30] + 0x20, gc_env.r[0]); // stw r0, 0x20(r30)
    gc_env.r[3] = gc_env.r[30] + 0; // addi r3, r30, 0x0
    gc_env.r[4] = 0x3; // li r4, 0x3
    HSD_GObj_80390ED0();
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x0); // lbz r0, 0x0(r31)
...
void Camera_80031328(void) {
    ...
    gc_env.r[4] = 0x20; // li r4, 0x20
    L_80031368:
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[10] + 0x0); // lbz r0, 0x0(r10)
    gc_env.r[0] = (gc_env.r[0] >> 3) & 0x1; // extrwi r0, r0, 1, 28
    gc_env.cr[0] = (gc_env.r[0] == 0) ? 0x2 : ((int32_t)gc_env.r[0] < 0 ? 0x8 : 0x4);
    if (gc_env.cr[0] == 0) goto L_80031380;
    gc_env.r[9] = 0x0; // li r9, 0x0
    gc_env.r[8] = gc_env.r[9] + 0; // addi r8, r9, 0x0
    goto L_80031388;
    L_80031380:
    gc_env.r[9] = 0x10; // li r9, 0x10
    gc_env.r[8] = 0x0; // li r8, 0x0
    L_80031388:
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[10] + 0x0); // lbz r0, 0x0(r10)
    gc_env.r[0] = (gc_env.r[0] >> 6) & 0x1; // extrwi r0, r0, 1, 25
    ...
    gc_env.r[11] = 0x0; // li r11, 0x0
    gc_env.r[10] = gc_env.r[11] + 0; // addi r10, r11, 0x0
    goto L_800313A8;
    L_800313A0:
    gc_env.r[11] = 0x40; // li r11, 0x40
    gc_env.r[10] = 0x0; // li r10, 0x0
    L_800313A8:
...
void Camera_800313E0(void) {
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[1] + 0x30, gc_env.r[28]); // stw r28, 0x30(r1)
    gc_env.r[28] = gc_env.r[3] + 0; // addi r28, r3, 0x0
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[4] + 0x398); // lbz r0, 0x398(r4)
    gc_env.r[4] = 0x1; // li r4, 0x1
    uint32_t rotated = gc_env.r[4] << 0; // rlwimi r0, r4, 0, 30, 31
    ...
    gc_mem_write32(gc_env.ram, gc_env.r[28] + 0x24, gc_env.r[0]); // stw r0, 0x24(r28)
    gc_env.r[0] = gc_env.r[3] | gc_env.r[4]; // or r0, r3, r4
    gc_mem_write32(gc_env.ram, gc_env.r[28] + 0x20, gc_env.r[0]); // stw r0, 0x20(r28)
    gc_env.r[3] = gc_env.r[28] + 0; // addi r3, r28, 0x0
    gc_env.r[4] = 0x3; // li r4, 0x3
    HSD_GObj_80390ED0();
    gc_env.r[0] = gc_mem_read8(gc_env.ram, gc_env.r[31] + 0x0); // lbz r0, 0x0(r31)
